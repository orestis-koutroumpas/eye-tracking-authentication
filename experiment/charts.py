...
plt.figtext(
    0.5,
    0.05,
    f"{labels1[0]} ({sizes1[0]})    |    {labels1[1]} ({sizes1[1]})",
    ha="center",
    fontsize=12,
    weight="bold",
    color="gray",
...
plt.figtext(
    0.5,
    0.05,
    f"{labels2[0]} ({sizes2[0]})    |    {labels2[1]} ({sizes2[1]})    |    {labels2[2]} ({sizes2[2]})",
    ha="center",
    fontsize=12,
    weight="bold",
    color="gray",
...
plt.figtext(
    0.5,
    0.05,
    f"{labels3[0]} ({sizes3[0]})    |    {labels3[1]} ({sizes3[1]})    |    {labels3[2]} ({sizes3[2]})",
    ha="center",
    fontsize=12,
    weight="bold",
    color="gray",
...
plt.figtext(
    0.5,
    0.05,
    f"{labels4[0]} ({sizes4[0]})    |    {labels4[1]} ({sizes4[1]})",
    ha="center",
    fontsize=12,
    weight="bold",
    color="gray",
...
plt.figtext(
    0.5,
    0.05,
    f"{labels5[0]} ({sizes5[0]})    |    {labels5[1]} ({sizes5[1]})",
    ha="center",
    fontsize=12,
    weight="bold",
    color="gray",
